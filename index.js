...
ScrollReveal().reveal(".header-image, .projects-container, .services-content", {
  origin: "bottom",
});
ScrollReveal().reveal(".header-content h1, .profile-photo, .skills-content", {
  origin: "left",
});
ScrollReveal().reveal(
  ".header-content p, .about-image, .skills-content:nth-child(2), .contact-image",
  { origin: "right" },
);
...
const serviceDetails = {
  web: {
    ...
    description:
      "I build fast, responsive websites and web applications with a clear visual hierarchy, dependable interactions, and code that is ready to grow with your business.",
    skills: [
  ...
  design: {
    ...
    description:
      "I create visual systems that make brands easier to recognise and content easier to understand, from first concept through polished digital assets.",
    skills: [
      "Brand identity",
  ...
  marketing: {
    ...
    description:
      "I turn audience and content signals into practical marketing actions, helping you improve visibility, engagement, and measurable growth.",
    skills: [
      "Content strategy",
      "Audience research",
      "Campaign reporting",
...
const serviceModalDescription = serviceModal?.querySelector(
  ".service-modal__description",
);
const serviceModalSkills = serviceModal?.querySelector(
  ".service-modal__skills",
);
const serviceModalIcon = serviceModal?.querySelector(
  ".service-modal__eyebrow i",
);
...
document.querySelectorAll(".service-trigger").forEach((trigger) => {
  trigger.addEventListener("click", () => {
    ...
    serviceModalSkills.innerHTML = service.skills
      .map(
        (skill) =>
          `<li><i class="fa-solid fa-check" aria-hidden="true"></i>${skill}</li>`,
      )
      .join("");
...
document.querySelectorAll(".project-trigger").forEach((trigger) => {
  trigger.addEventListener("click", () => {
    ...
    projectModal.querySelector("#project-modal-title").textContent =
      project.title;
    ...
    projectModal.querySelector(".project-modal__story").textContent =
      project.story;
    projectModal.querySelector(".project-modal__brief").textContent =
      project.brief;
    projectModal.querySelector(".project-modal__approach").textContent =
      project.approach;
    projectModal.querySelector(".project-modal__tools").innerHTML =
